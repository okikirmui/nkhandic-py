...
class NkHandicPaths:
    ...
    def dicdir(self) -> Path:
        ...
        if not path.exists():
            raise FileNotFoundError(
                f"NK-HanDic directory not found: {path}\n"
    ...
    def version_file(self) -> Path:
        ...
        if not vpath.exists():
            raise FileNotFoundError(f"NK-HanDic version file not found: {vpath}")
        return vpath

    def version(self) -> str:
        """
        Read and return NK-HanDic version string.
        """
